    ...
    <script>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="drive_link_${event.id}" value="${event.drive_link || ''}" placeholder="Enter Google Drive link">
                            ...
                            ${event.drive_link ? '<p><a href="' + event.drive_link + '" target="_blank" class="btn btn-sm btn-info"><i class="fab fa-google-drive"></i> Open Files</a></p>' : ''}                                            
        ...
        function generateEventHTML(events) {
            ...
            html += '<div class="event-item-header">' +
                    ...
                    '<ul>' +
                    '<li><span class="event-time">Time</span><span class="event-city">City</span><span class="event-university">University</span><span class="event-location">Location</span><span class="event-photographer">Photographer</span><span class="event-client">Client</span></li>' +
                    '</ul>' +
                    '</div>' +
                    '</div>' +
                    '</div>';
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        if (eventIndex >= 0) {
                            allEventsData[eventIndex].drive_link = driveLink;
                        }
